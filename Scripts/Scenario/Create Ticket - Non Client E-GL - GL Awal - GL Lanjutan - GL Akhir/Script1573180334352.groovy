...
WebUI.callTestCase(findTestCase('Pages/Web/Claim/Claim'), [('StatusMember') : StatusMember, ('NewMemberType') : NewMemberType
...
WebUI.callTestCase(findTestCase('Pages/Web/Claim/Claim'), [('StatusMember') : StatusMember, ('GLType') : GLType2])
...
WebUI.callTestCase(findTestCase('Pages/Web/Claim/Claim'), ('StatusMember') : StatusMember, [('GLType') : GLType3])
